...
/**
 * @class ModelAPIRouter - description
 *
 * @param  {mongoose.Model|String}  model    model to be exposed
 * @param  {Object}                 options  exposion options
...
ModelAPIRouter.prototype.option = function(method, name) {
  return this.apiOptions[method] && this.apiOptions[method][name] || this.apiOptions[name];
}
 ...
 *
 * @param  {ModelAPIExpress} app    the express application to which the router
 * should be add
